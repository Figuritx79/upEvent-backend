		...
		http.csrf(AbstractHttpConfigurer::disable)
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers("/api/user/profile", "/api/event/events/**", "/api/user/update",
								...
								"/api/checker/register", "/api//participant/register", "/api/occupation/", "/api/occupation", "/api/occupation/own", "/api/registration/own", "/api/user-workshops/validate-attendance")
